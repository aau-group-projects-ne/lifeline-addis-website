                    ...
                    <aside className="w-72 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col justify-between py-6">
                        <div className="flex flex-col gap-8">
                            ...
                            <div className="px-6 flex items-center gap-3">
                                ...
                                />
                                <div>
                                    <h1 className="font-bold">Sarah Caregiver</h1>
                                    <p className="text-xs uppercase text-slate-400">Certified Nurse</p>
                                </div>
                            </div>
                    ...
                    <main className="flex-1 overflow-y-auto px-8 py-10 max-w-5xl mx-auto">
                        ...
                        <section className="bg-white dark:bg-slate-900 p-6 rounded-xl border mb-10">
                            ...
                            <div className="grid grid-cols-[60px_1fr] gap-x-4">
                                {[
                                    ["notifications_active", "Martha Smith", "08:00 AM • 123 Maple St.", true],
                                    ["person", "James Wilson", "11:30 AM • 456 Oak Ave."],
                                    ["medical_services", "Robert Miller", "05:00 PM • 789 Pine Rd."],
                                ].map(([icon, name, details, active], i) => (
                                    <div key={i} className="contents">
                                        <div className="flex flex-col items-center">
                                            <div
                                                className={`size-8 rounded-full flex items-center justify-center ${active
                                            ...
                                            {i < 2 && <div className="w-[2px] h-16 bg-slate-200 dark:bg-slate-700" />}
                                        </div>

                                        <div className="pb-8">
                                            <p className={`font-bold ${active ? "text-primary" : ""}`}>
                                                {name}
                                            </p>
